...
- You need Ruby installed successfuly
- You need irb to run the application
### Setup
...
```sh
  cd my-folder
  git clone https://github.com/emmanuellmhango/ruby-oop.git
```
...
I would like to thank all who helped me during the project. Special thanks go to Microverse for the technical and moral support they have offered.
